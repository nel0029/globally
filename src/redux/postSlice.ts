    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(like.fulfilled, (state, action) => {
                ...
                if (state.postDetails !== null && state.postDetails?._id === likedPost.parentID) {
                ...
                if (state.postReplies !== null) {
                    const postIndex = state.postReplies.findIndex((post: any) => post._id === likedPost.parentID)
                    if (postIndex !== -1) {
                ...
                if (state.userPostsList !== null) {
                    const postIndex = state.userPostsList.findIndex((post: any) => post._id === likedPost.parentID)
                    if (postIndex !== -1) {
                ...
                if (state.userRepliesList !== null) {
                    const postIndex = state.userRepliesList.findIndex((post: any) => post._id === likedPost.parentID)
                    if (postIndex !== -1) {
                ...
                if (state.userRepostsList !== null) {
                    const postIndex = state.userRepostsList.findIndex((post: any) => post._id === likedPost.parentID)
                    if (postIndex !== -1) {
                ...
                if (state.userLikesList !== null) {
                    const postIndex = state.userLikesList.findIndex((post: any) => post._id === likedPost.parentID)
                    if (postIndex !== -1) {
            ...
            .addCase(unlike.fulfilled, (state, action) => {
                ...
                if (state.postReplies !== null) {
                    const postIndex = state.postReplies.findIndex((post: any) => post._id === unlikedData.parentID)
                    if (postIndex !== -1) {
                ...
                if (state.userPostsList !== null) {
                    const postIndex = state.userPostsList.findIndex((post: any) => post._id === unlikedData.parentID)
                    if (postIndex !== -1) {
                ...
                if (state.userRepliesList !== null) {
                    const postIndex = state.userRepliesList.findIndex((post: any) => post._id === unlikedData.parentID)
                    if (postIndex !== -1) {
                ...
                if (state.userRepostsList !== null) {
                    const postIndex = state.userRepostsList.findIndex((post: any) => post._id === unlikedData.parentID)
                    if (postIndex !== -1) {
                ...
                if (state.userLikesList !== null) {
                    const postIndex = state.userLikesList.findIndex((post: any) => post._id === unlikedData.parentID)
                    if (postIndex !== -1) {
                    ...
                    if (userID === unlikedData.authorID) {
                        ...
                        state.userLikesList = state.userLikesList.filter((like: any) => like._id !== unlikedData.parentID)
                    }
            ...
            .addCase(createReply.fulfilled, (state, action) => {
                ...
                if (state.postReplies !== null) {
                    const replyIndex: number = state.postReplies.findIndex((reply: any) => {
                ...
                if (state.userPostsList !== null) {
                    const postIndex = state.userPostsList.findIndex((post: PostsDataProps) => post._id === newReply.parentPostID)
                    if (postIndex !== -1) {
                ...
                if (state.userRepliesList !== null) {
                    const replyIndex: number = state.userRepliesList.findIndex((reply: any) => {
                        return reply._id === newReply.parentPostID
                    })
                ...
                if (state.userRepostsList !== null) {
                    const postIndex = state.userRepostsList.findIndex((post: PostsDataProps) => post._id === newReply.parentPostID)
                    if (postIndex !== -1) {
            ...
            .addCase(deleteReply.fulfilled, (state, action) => {
                ...
                if (state.PostData !== null) {
                    const parentIndex = state.PostData.findIndex((post: any) => post._id === deletedReplyID.parentPostID)
                ...
                if (state.postDetails !== null) {
                    ...
                    if (state.postReplies !== null) {
                        state.postReplies = state.postReplies.filter((reply: any) => reply._id !== deletedReplyID.postID)
                        state.postDetails.repliesCount -= 1
                    }
                ...
                if (state.postReplies !== null) {
                    state.postReplies = state.postReplies.filter((reply: ReplyDataProps) => reply._id !== deletedReplyID.postID)
                }

                if (state.userPostsList !== null) {
                    const postIndex = state.userPostsList.findIndex((post: PostsDataProps) => post._id === deletedReplyID.postID)
                ...
                if (state.userRepliesList !== null) {
                    const postIndex = state.userRepliesList.findIndex((post: PostsDataProps) => post._id === deletedReplyID.postID)

                    if (postIndex !== -1) {
                        state.userRepliesList[postIndex].repliesCount -= 1
                    }

                    state.userRepliesList = state.userRepliesList.filter((reply: ReplyDataProps) => reply._id !== deletedReplyID.postID)
                }

                if (state.userRepostsList !== null) {
                    const postIndex = state.userRepostsList.findIndex((post: PostsDataProps) => post._id === deletedReplyID.postID)
            ...
            .addCase(deleteRepost.fulfilled, (state, action) => {
                ...
                if (state.PostData !== null) {
                    ...
                    state.PostData = state.PostData.filter((post: any) => post._id !== deletedRepostID.postID)
                ...
                if (state.userRepostsList !== null) {
                    state.userRepostsList = state.userRepostsList.filter((repost: RepostDataProps) => repost._id !== deletedRepostID.postID)
                }
            })
            ...
            .addCase(follow.fulfilled, (state, action) => {
                ...
                if (state.postReplies !== null) {
                    const replyIndex = state.postReplies.findIndex((reply: ReplyDataProps) => reply.authorID === followResponse.followingID)
                    if (replyIndex !== -1) {
                ...
                if (state.userPostsList !== null) {
                    const postIndex = state.userPostsList.findIndex((post: any) => post.authorID === followResponse.followingID)
                ...
                if (state.userRepliesList !== null) {
                    const postIndex = state.userRepliesList.findIndex((post: any) => post.authorID === followResponse.followingID)
                ...
                if (state.userRepostsList !== null) {
                    const postIndex = state.userRepostsList.findIndex((post: any) => post.authorID === followResponse.followingID)
                ...
                if (state.userLikesList !== null) {
                    const postIndex = state.userLikesList.findIndex((post: any) => post.authorID === followResponse.followingID)
            ...
            .addCase(unfollow.fulfilled, (state, action) => {
                ...
                if (state.postReplies !== null) {
                    const replyIndex = state.postReplies.findIndex((reply: ReplyDataProps) => reply.authorID === unfollowResponse.followingID)
                    if (replyIndex !== -1) {
                ...
                if (state.userDetails !== null) {
                    ...
                    if (state.userFollowers !== null) {
                        const followerIndex = state.userFollowers.findIndex((follower: any) => follower._id === unfollowResponse.followingID)

                        const userID = localStorage.getItem("userID")
                        if (state.userDetails._id === userID) {
                            state.userFollowing = state.userFollowers.filter((follower: any) => follower._id !== unfollowResponse.followingID)
                        } else {
                            state.userFollowers[followerIndex].isUserFollowed = false
                            state.userFollowers[followerIndex].followID = unfollowResponse.followID
                        }
                    }

                    if (state.userFollowing !== null) {
                        const followerIndex = state.userFollowing.findIndex((follower: any) => follower._id === unfollowResponse.followingID)

                        const userID = localStorage.getItem("userID")
                        if (state.userDetails._id === userID) {
                            state.userFollowing = state.userFollowing.filter((follower: any) => follower._id !== unfollowResponse.followingID)
                        } else {
                            state.userFollowing[followerIndex].isUserFollowed = false
                            state.userFollowing[followerIndex].followID = unfollowResponse.followID
                        }
                    }
                }
                ...
                if (state.userPostsList !== null) {
                    const postIndex = state.userPostsList.findIndex((post: any) => post.authorID === unfollowResponse.followingID)
                ...
                if (state.userRepliesList !== null) {
                    const postIndex = state.userRepliesList.findIndex((post: any) => post.authorID === unfollowResponse.followingID)
                ...
                if (state.userRepostsList !== null) {
                    const postIndex = state.userRepostsList.findIndex((post: any) => post.authorID === unfollowResponse.followingID)
                ...
                if (state.userLikesList !== null) {
                    const postIndex = state.userLikesList.findIndex((post: any) => post.authorID === unfollowResponse.followingID)
            ...
            .addCase(createNewPollResponse.fulfilled, (state, action) => {
                ...
                if (state.PostData !== null) {
                    const postIndex = state.PostData.findIndex((post: PostsDataProps) => post._id === responsePollData.postID)
                    if (postIndex !== -1) {
                        state.PostData[postIndex].hasChoosed = true
                        state.PostData[postIndex].optionChoosedID = responsePollData.optionID
                        state.PostData[postIndex].pollRespondentsCount += 1

                        const optionIndex = state.PostData[postIndex].pollOptions.findIndex((option: any) => option._id === responsePollData.optionID)
                        if (optionIndex !== -1) {
                ...
                if (state.postDetails !== null) {
                    if (state.postDetails._id === responsePollData.postID) {
                        ...
                        const optionIndex = state.postDetails.pollOptions.findIndex((option: any) => option._id === responsePollData.optionID)
                        if (optionIndex !== -1) {
