...
export const verifyUserName = createAsyncThunk(
  "userSlice/verifyUserName",
  async (userName: string) => {
    try {
      const response = await axios.get(
        `/auth/verify/username/?userName=${userName}`
      );
...
export const isServerActive = createAsyncThunk("isServerActive", async () => {
  try {
