...
import { addNewNotifcation, resetNotificationsCount } from '../redux/messageSlice'
    ...
    return (
        <div className='lg:max-w-[300px] lg:flex-grow h-screen flex-grow-0 sticky hidden sm:flex flex-col items-center justify-center left-0 top-0 bottom-0 border-r dark:border-Dark300'>
            ...
            <div className='w-full flex flex-col flex-grow justify-between items-center p-2 gap-y-2'>
                ...
                <div
                    className='w-full flex flex-col items-center lg:items-start gap-y-2'>
                    <div
                        onClick={goToAccountSettings}
                        className={`${activeTab === '/account/setting' ? ' text-secondary ' : ''} flex flex-row items-center text-xl gap-x-2 p-2 lg:pl-4 lg:pr-6 py-1 cursor-pointer hover:text-secondary hover:scale-110`}>
