          ...
          {authorized && (
            <MenuItem>
              ...
              >
                ...
                <p className="whitespace-nowrap">Delete Reply</p>
              </button>
            </MenuItem>
          )}
        </MenuContainer>
        ...
        <Modal setModal={setEditModal}>
          <div className="w-full flex flex-row justify-start items-center gap-x-2 py-1">
            <img
              ...
              src={reply.postAuthorAvatarURL.url}
            />
            <div className="flex-grow flex flex-col justify-center leading-none">
              <p className="text-base font-bold">
                {reply.postAuthorFirstName} {reply.postAuthorMiddleName}{" "}
                {reply.postAuthorLastName}
              </p>
              <p className="text-sm">@{reply.postAuthorUserName}</p>
            </div>
          </div>
      ...
      {deleteModal && (
        <Modal setModal={setDeleteModal}>
          ...
          <div className="w-full flex justify-end items-center gap-x-2">
            ...
            <DeleteButton onClick={[removeReply]}>Delete</DeleteButton>
          </div>
        </Modal>
      )}
    </div>
