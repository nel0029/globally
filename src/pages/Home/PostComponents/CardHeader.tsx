...
const CardHeader: React.FC<CardHeaderProps> = ({ firstName, middleName, lastName, userName, createdAt, children }) => {
    ...
    return (
        <div className='w-full flex flex-row flex-shrink h-auto justify-stretch items-center py-1 overflow-hidden'>
            <div className='flex flex-col justify-start gap-x-2 leading-none flex-1 flex-shrink '>
                <div
                    className='flex flex-row items-center gap-x-2 text-[1rem] leading-[1.25rem] cursor-pointer flex-shrink flex-wrap max-w-[calc(100%-8px)] overflow-x-hidden'>
                    <div
                        onClick={userProfile}
