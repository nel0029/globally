...
import { Outlet, useParams, Route, Link, useLocation, Routes, useNavigate } from 'react-router-dom';
...
import { createNewConvo, createNewMessage, updateConvo } from '../../redux/messageSlice';
...
const Messages = () => {
    ...
    return (
        <div className="w-full flex-grow flex flex-col items-center justify-center gap-y-2 top-0 bottom-0">
            ...
            <div className='z-[100] dark:bg-Dark100 bg-slate-100 flex-grow flex lg:hidden w-full'>
                <Routes>
            ...
            <div className='hidden h-screen lg:flex w-full top-0 bottom-0'>
