        ...
        <div className='w-full flex flex-col gap-y-2'>
            ...
            <div className="w-full p-2 flex flex-row items-center justify-start gap-x-2 overflow-x-auto flex-nowrap flex-shrink snap-mandatory scroll-px-9 transform-gpu no-scrollbar">
                <div
                    ...
                    className={`${activeTab === `/${userDetails?.userName}/following` ? 'border-b-4 border-secondary font-bold' : ''} py-1 px-5 flex-shrink-0 flex-1 flex flex-row justify-center items-center cursor-pointer`}>
                    Following
                </div>
                <div
                    onClick={goToUserFollowers}
                    className={`${activeTab === `/${userDetails?.userName}/followers` ? 'border-b-4 border-secondary font-bold' : ''} py-1 px-5 flex-shrink-0 flex-1 flex flex-row justify-center items-center cursor-pointer`}>
                    Followers
                </div>
